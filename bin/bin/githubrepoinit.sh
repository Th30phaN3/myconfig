...
#
# NOT FINISHED
# This script create a new repo on github.com, then init/clone it and pushes some files as the first commit (README.md + .gitignore)
...
if [ "$(ls -a $CURRENTDIR)" ]
  then # Already existing project, init and add remote
    git init
    git remote add origin git@github.com:$USERNAME/$REPONAME.git
  else # Clone the freshly created repo inside folder
