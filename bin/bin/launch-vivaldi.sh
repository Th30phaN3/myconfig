...
/usr/bin/vivaldi --use-gl=desktop --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36" --cast-app-background-color="ff2e2e2e" --default-background-color="ff2e2e2e" --disable-breakpad --disable-speech-api --allow-insecure-localhost
